...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create web-777f
  fly apps create web-777f-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app web-777f
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app web-777f-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'web-777f-staging' does not match app name in config file 'web-777f'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name web-777f-db
  fly postgres attach --app web-777f web-777f-db

  fly postgres create --name web-777f-staging-db
  fly postgres attach --app web-777f-staging web-777f-staging-db
  ```
