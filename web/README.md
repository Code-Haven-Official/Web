...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create web-545e
  fly apps create web-545e-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app web-545e
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app web-545e-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'web-545e-staging' does not match app name in config file 'web-545e'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name web-545e-db
  fly postgres attach --app web-545e web-545e-db

  fly postgres create --name web-545e-staging-db
  fly postgres attach --app web-545e-staging web-545e-staging-db
  ```
